...
class MainWindow(Tk, Singleton):
    ...
    def __init__(self):
        ...
        self.preview = None
        transparent_image = Image.new('RGBA', (600, 600), (255, 255, 255, 0))
        self.image = ImageTk.PhotoImage(transparent_image)
        # Make the window transparent
        # self.attributes('-transparentcolor', 'grey')
        # self.configure(bg='grey', relief='solid')
        ...
        # self.overlay_canvas = Canvas(main_frame, width=600, height=600)
        # self.overlay_canvas.create_image(0, 0, image=self.image, anchor=NW)
        # self.overlay_canvas.image = self.image
        # self.overlay_canvas.place(x=0, y=0)
        # self.logo_preview = Canvas(main_frame, width=35, height=35, bd=0, highlightthickness=0)
        # self.logo_preview.grid(column=0, row=1, rowspan=11, pady=30, padx=30)
        # # self.logo_preview.grid_forget()
        #
        # # Canvas for text
        # self.text_preview = Canvas(main_frame, width=30, height=20)
        # self.text_preview.grid(column=0, row=2,  pady=10, padx=10)
        # # self.text_preview.grid_forget()
        ...
        # Logo label preview_img
        # self.label_logo = Canvas(frame, bg=bg_color, height=20, width=20)
        # self.label_logo.grid(column=1, row=3, pady=5, sticky=N)
        # Upload logo button
        ...
        # Change size
        self.change_size = Scale(frame, from_=1, to=10, resolution=0.2, orient="horizontal",
        ...
        # Change space
        self.change_space = Scale(frame, from_=30, to=500, orient="horizontal", label='Space', length=180,
                                  activebackground='red', bg='#F1E5D1')
